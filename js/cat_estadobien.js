function load_frm()
{
   ...
   $("#DivTrabajo").empty();
   $.ajax({
                url:'../../../scripts/oper_cat_estadobien.php?o=1',
		type:'POST',
...
function add_tbi()
{
    ...
    if(v1=="")
    {
       jQuery('#txtTBI').validationEngine('validate');  
              ...
              $.ajax({
                    url:'../../../scripts/oper_cat_estadobien.php?o=2',
                    type:'POST',
                    data:losdatos,
                    success:function(data)
                    {
 ...
 function frm_buscador_tbi()
 {
     $("#DivTrabajo").empty();
      $.ajax({
                url:'../../../scripts/oper_cat_estadobien.php?o=3',
		type:'POST',
		success:function(data)
                {
                    $("#DivTrabajo").append(data);    
    ...
    else
        {
            $("#DivBusqueda").empty();  
             var losdatos = {txtTBI:$("#txtTBI").val()};
              $.ajax({
                        url:'../../../scripts/oper_cat_estadobien.php?o=4',
                        type:'POST',
                        data:losdatos,
                        cache:false,
                        success:function(data)
...
function frm_editar_tbi(id)
{
     ...
     var losdatos = {IdTBI:id};
      $.ajax({
                url:'../../../scripts/oper_cat_estadobien.php?o=5',
		type:'POST',
                data:losdatos,
                cache:false,
		success:function(data)
  ...
  var v1=$("#txtTBIE").val();
    ...
    if(v1=="")
    {
       jQuery('#txtTBIE').validationEngine('validate');  
              ...
              $.ajax({
                        url:'../../../scripts/oper_cat_estadobien.php?o=6',
                        type:'POST',
                        data:losdatos,
                        cache:false,
                        success:function(data)
...
function frm_buscador_borrar()
{
    $("#DivTrabajo").empty();
      $.ajax({
                url:'../../../scripts/oper_cat_estadobien.php?o=7',
		type:'POST',
		success:function(data)
                {
                    $("#DivTrabajo").append(data);    
        ...
        if(texto=="")
           {
              jQuery('#txtTBI').validationEngine('validate');
           ...
           else
               {
                     $("#DivBusqueda").empty();  
                     $.ajax({
                               url:'../../../scripts/oper_cat_estadobien.php?o=8',
                               type:'POST',
                               data:losdatos,
                               cache:false,
                               success:function(data)
...
function borrar_tbi(id)
{
     ...
     smoke.confirm('Realmente desea borrar este registro?',function(e)
   {
	if (e)
        {
            $.ajax({
                url:'../../../scripts/oper_cat_estadobien.php?o=9',
		type:'POST',
                data:losdatos,
                cache:false,
		success:function(data)
...
function frm_buscador_consultar()
{
    $("#DivTrabajo").empty();
      $.ajax({
                url:'../../../scripts/oper_cat_estadobien.php?o=10',
		type:'POST',
		success:function(data)
                {
                    $("#DivTrabajo").append(data);    
        ...
        if(texto=="")
           {
              jQuery('#txtTBI').validationEngine('validate');
           ...
           else
               {
                     $("#DivBusqueda").empty();  
                     $.ajax({
                               url:'../../../scripts/oper_cat_estadobien.php?o=11',
                               type:'POST',
                               data:losdatos,
                               cache:false,
                               success:function(data)
