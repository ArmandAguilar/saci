...
<!-- Begin Libs  --> 
 ...
 <script src="<?php echo $url; ?>/js/procesos_facturas.js" type="text/javascript"></script>
 <!-- Smoke -->
...
<body onload="load_frm();MM_preloadImages('../../interfaz_modulos/botones/funciones_over.png','../../interfaz_modulos/botones/salir_over.jpg','../../interfaz_modulos/botones/agregar_over.jpg','../../interfaz_modulos/botones/modificar_over.jpg','../../interfaz_modulos/botones/borrar_over.jpg','../../interfaz_modulos/botones/consultar_over.jpg','../../interfaz_modulos/botones/imprimir_over.jpg')">
...
<div id="apDiv8"><img src="../../interfaz_modulos/botones/agregar.jpg" name="Image6" width="120" height="45" border="0" id="Image6" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','../../interfaz_modulos/botones/agregar_over.jpg',1)" style="cursor:pointer" onclick="load_frm();" /></div>
<div id="apDiv9"></div>
<div id="apDiv10"><img src="../../interfaz_modulos/botones/modificar.jpg" name="ImageModificar8" width="120" height="45" border="0" id="ImageModificar8"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageModificar8','','../../interfaz_modulos/botones/modificar_over.jpg',1)" style="cursor:pointer" onclick="frm_buscar_modificar();"/></div>
<div id="apDiv12"><img src="../../interfaz_modulos/botones/borrar.jpg" name="Image7" width="120" height="45" border="0" id="Image7" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','../../interfaz_modulos/botones/borrar_over.jpg',1)" style="cursor:pointer" onclick="frm_buscar_eliminar();"/></div>
<div id="apDiv13"><img src="../../interfaz_modulos/botones/consultar.jpg" name="Image9" width="120" height="45" border="0" id="Image9" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','../../interfaz_modulos/botones/consultar_over.jpg',1)" style="cursor:pointer" onclick="frm_consultar();"/></div>
</div>
    <div id="dialog" title="Pedido">
        <table>
            <tr>
