...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    ?>
        ...
        <script src="<?php echo $url; ?>/js/procesos_entrada_agregar.js" type="text/javascript"></script>
        <script src="<?php echo $url; ?>/js/procesos_entrada_consultar.js" type="text/javascript"></script>
        <script src="<?php echo $url; ?>/js/procesos_entrada_modificar.js" type="text/javascript"></script>
         <!-- Smoke -->
  ...
  #apDiv7 {
    ...
    <body onload="load_frm();MM_preloadImages('../../interfaz_modulos/botones/funciones_over.png','../../interfaz_modulos/botones/salir_over.jpg','../../interfaz_modulos/botones/traspasar_over.jpg','../../interfaz_modulos/botones/limpiar_over.jpg','../../interfaz_modulos/botones/aceptar_over.jpg')">
        ...
        <!-- Modificar //-->
        <div id="DInvSustitucionModificar" title="No. Inventario Modificar">
                <table>
                    <tr>
                        <td><input type="text" name="txtPatronDInvSustitucionModificar" id="txtPatronDInvSustitucionModificar" class="boxes_form400px"/></td>
                        <td>&nbsp;&nbsp;&nbsp;<img src="../../interfaz_modulos/botones/buscar.jpg" name="ImageBTB4" width="120" height="45" border="0" id="ImageBTB4" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageBTB4','','../../interfaz_modulos/botones/buscar_over.jpg',1)" style="cursor:pointer" onclick="buscar_solo_inv_modifcar();"/></td>
                    </tr>
                </table>
                 <table>
                        <tr>
                            <td><div class="txt_titulos_bold">Clave:<input type="checkbox" name="chkCveDInvSustitucionModificar" id="chkCveDInvSustitucionModificar" value="Si"/></div></td>
                            <td><div class="txt_titulos_bold">Nombre:<input type="checkbox" name="chkNombreDInvSustitucionModificar" id="chkNombreDInvSustitucionModificar" value="Si"/></div></td>
                        </tr>
                    </table>   
                    <div id="GridBusquedatxtPatronDInvSustitucionModificar"></div>
                    <center><div id="DivLoadtxtPatronDInvSustitucionModificar" style="display:none"><img src="../../../interfaz/cargando.png"/></div></center>      
        </div>
    </body>
</html>
