...
<!-- Begin Libs  --> 
 ...
 <script src="<?php echo $url; ?>/js/procesos_calculoconsumopromedio.js" type="text/javascript"></script>
 <!-- Smoke -->
...
<body onload="MM_preloadImages('../../interfaz_modulos/botones/funciones_over.png','../../interfaz_modulos/botones/salir_over.jpg','../../interfaz_modulos/botones/iniciar_p_over.jpg')">
...
<div class="txt_titulo_secciones" id="apDiv11"> / Consumibles / Salida / Cálculo de Consumo Promedio</div>
...
<div id="apDiv5">
    <br></br><br>
    <center><div id="DivLoad1" style="display:none"><img src="../../../interfaz/Loading.gif"/></div></center>
</div>
<div id="apDiv6"></div>
...
<div id="apDiv8"><img src="../../interfaz_modulos/botones/iniciar_p.jpg" name="Image4" width="120" height="45" border="0" id="Image4" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','../../interfaz_modulos/botones/iniciar_p_over.jpg',1)" style="cursor:pointer" onclick="calculo();"/></div>
</div>
</body>
</html>
