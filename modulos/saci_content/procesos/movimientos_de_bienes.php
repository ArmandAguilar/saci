...
<!-- Begin Libs  --> 
 ...
 <script src="<?php echo $url; ?>/js/procesos_movimientobienes.js" type="text/javascript"></script>
...
<body onload="load_frm();MM_preloadImages('../../interfaz_modulos/botones/funciones_over.png','../../interfaz_modulos/botones/salir_over.jpg','../../interfaz_modulos/botones/agregar_over.jpg','../../interfaz_modulos/botones/consultar_over.jpg','../../interfaz_modulos/botones/baja_over.jpg')">
...
<div class="txt_titulo_secciones" id="apDiv11"> / Inventariables / Movimientos de Bienes</div>
...
<div id="apDiv5">
<input type="hidden" name="txtIDCAMBS" id="txtIDCAMBS"/>
<input type="hidden" name="txtIdConsecutivo" id="txtIdConsecutivo" />
<input type="hidden" name="txtEdoMovientoActual" id="txtEdoMovientoActual" />
...
<div id="apDiv8"><img src="../../interfaz_modulos/botones/baja.jpg" name="Image8" width="120" height="45" border="0" id="Image8" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','../../interfaz_modulos/botones/baja_over.jpg',1)" style="cursor:pointer;" onclick="baja();"/></div>
<div id="apDiv9"><img src="../../interfaz_modulos/botones/agregar.jpg" name="Image6" width="120" height="45" border="0" id="Image6"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','../../interfaz_modulos/botones/agregar_over.jpg',1)" style="cursor:pointer;" onclick="registar_movimiento();"/></div>
<div id="apDiv12"><img src="../../interfaz_modulos/botones/consultar.jpg" name="Image9" width="120" height="45" border="0" id="Image9"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','../../interfaz_modulos/botones/consultar_over.jpg',1)" style="cursor:pointer" onclick="consultar();"/></div>
</div>
<div id="dialog" title="No. Invetario">
        <table>
            <tr>
                <td><input type="text" name="txtPatron" id="txtPatron" class="boxes_form400px"/></td>
                <td>&nbsp;&nbsp;&nbsp;<img src="../../interfaz_modulos/botones/buscar.jpg" name="ImageBTB" width="120" height="45" border="0" id="ImageBTB" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageBTB','','../../interfaz_modulos/botones/buscar_over.jpg',1)" style="cursor:pointer" onclick="buscar_inv();"/></td>
            </tr>
        </table>
            <table>
                <tr>
 ...
 <div id="dialog2" title="Resguardantes">
        <input type="hidden" name="txtRow" id="txtRow" value="0"/>
        <table>
            <tr>
                <td><input type="text" name="txtPatron2" id="txtPatron2" class="boxes_form400px"/></td>
                <td>&nbsp;&nbsp;&nbsp;<img src="../../interfaz_modulos/botones/buscar.jpg" name="ImageBResguardantes" width="120" height="45" border="0" id="ImageBResguardantes" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageBResguardantes','','../../interfaz_modulos/botones/buscar_over.jpg',1)" style="cursor:pointer" onclick="buscar_empleado();"/></td>
            </tr>
        </table>
            <table>
                <tr>
                    <td><div class="txt_titulos_bold">Clave:<input type="checkbox" name="chkClave2" id="chkClave2" value="Clave"/></div></td>
                    <td><div class="txt_titulos_bold">Nombre:<input type="checkbox" name="chkNombre" id="chkNombre" value="Nombre"/></div></td>
                </tr>
            </table>
 ...
 <div id="dialog3" title="Unidad Admin.">
        <table>
            <tr>
                <td><input type="text" name="txtPatron3" id="txtPatron3" class="boxes_form400px"/></td>
                <td>&nbsp;&nbsp;&nbsp;<img src="../../interfaz_modulos/botones/buscar.jpg" name="ImageBUAdministrativa" width="120" height="45" border="0" id="ImageBUAdministrativa" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ImageBUAdministrativa','','../../interfaz_modulos/botones/buscar_over.jpg',1)" style="cursor:pointer" onclick="buscar_ua();"></td>
            </tr>
        </table>
            <table>
                <tr>
                    <td><div class="txt_titulos_bold">Clave:<input type="checkbox" name="chkClave3" id="chkClave3" value="Clave"/></div></td>
                    <td><div class="txt_titulos_bold">Descripci&oacute;n:<input type="checkbox" name="chkDescripcion3" id="chkDescripcion3" value="Descripcion"/></div></td>
                    
                </tr>
            </table> 
            <div id="GridBusqueda3"></div>
 </div>
</body>
</html>
