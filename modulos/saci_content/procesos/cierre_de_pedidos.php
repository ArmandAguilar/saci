...
<body onload="MM_preloadImages('../../interfaz_modulos/botones/funciones_over.png','../../interfaz_modulos/botones/salir_over.jpg','../../interfaz_modulos/botones/desplegar_over.jpg')">
<div class="modulos" id="apDiv1"></div>
<div class="inicio" id="apDiv2"></div>
<div class="txt_titulo_secciones" id="apDiv11"> / Pedidos / Cierre de Pedidos</div>
...
<div id="apDiv8"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','../../interfaz_modulos/botones/desplegar_over.jpg',1)"><img src="../../interfaz_modulos/botones/desplegar.jpg" name="Image4" width="120" height="45" border="0" id="Image4" /></a></div>
</body>
</html>
