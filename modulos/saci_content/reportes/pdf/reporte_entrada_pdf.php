<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'De Entradas',0,0,'C');
            // Salto de línea
        ...
        {
            $this->AnchoColumnas = array(30,20,20,40,25,20,20,20,20,30,40);
            $this->CabeceraTabla = array('Cve.Cabms','Fecha','Num.Pedido','Documento','Total','Cantidad','Cve.Cabms','Cabms','Tipo Mov.','Cve.Proveedor','Proveedor');
