...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Ln(5);
		$this->Cell(0,5,'Con Costo Promedio',0,0,'C');
		// Salto de línea
	...
	{
		$this->AnchoColumnas = array(30,50,50,20,20,20,20,30,30,30,30);
		$this->CabeceraTabla = array('Cambs','Descripcion','U. Medida','Stock Min.','Stock Max.','C. Promedio','Exis. Incial','Mov.Entrada','Acomulados Salida');
		$RC = new Reporte_ConSin();
		
		$info->Fecha1 =$FechaInicial;
		$info->Fecha2 =$FechaFinal;
		$this->DatosCatalogo = $RC->print_pdf_con($info);
	}
