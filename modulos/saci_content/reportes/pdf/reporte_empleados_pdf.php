<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'de Empleados',0,0,'C');
            // Salto de línea
        ...
        {
            $this->AnchoColumnas = array(20, 100, 35, 30, 30, 40, 20);
            $this->CabeceraTabla = array('No. Empleado', 'Nombre', 'RFC', 'Zona de Pago', 'Z. P. Ant.', 'Cargo', 'Estado');
            $RC = new Reporte_Catalogos();
            $this->DatosCatalogo = $RC->ObtenerArregloCatalogoEmpleados();
        }
