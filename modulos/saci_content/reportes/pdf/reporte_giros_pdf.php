<?php
    ...
    class PDF extends FPDF
    {
        ...
        {
            $this->AnchoColumnas = array(20, 255);
            $this->CabeceraTabla = array('IDGiro', utf8_decode('Descripción'));
            $RC = new Reporte_Catalogos();
            $this->DatosCatalogo = $RC->ObtenerArregloCatalogoGiros();
        }
        ...
        function GenerarReporte()
        {
            ...
            $this->Output('reporte_catalogo_giros.pdf', 'I');
        }
    }
