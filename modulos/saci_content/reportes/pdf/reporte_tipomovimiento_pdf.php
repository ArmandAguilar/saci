<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'de Tipo de Movimiento',0,0,'C');
            // Salto de línea
        ...
        {
            $this->AnchoColumnas = array(10,30,110,25,25,25,25,25);
            $this->CabeceraTabla = array('Id','Tipo Movimiento','Descripcion','Entrada','Baja','Tipo Almacen','Salida','Estado Mov.');
            $RC = new Reporte_Catalogos();
            $this->DatosCatalogo = $RC->ObtenerArregloCatalogoTipoMovimiento();
        }
        ...
        function GenerarReporte()
        {
            ...
            foreach($this->DatosCatalogo as $Dato)
            {
                ...
                $this->Cell($this->AnchoColumnas[0],6,$Dato[8],'', 0, 'C');
                
                
                $this->Ln();
            }
            $this->Output('reporte_catalogo_tipomovimiento.pdf', 'I');
        }
    }
