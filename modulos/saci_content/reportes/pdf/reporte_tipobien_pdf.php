<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'de Tipo de Bien Invetariable',0,0,'C');
            // Salto de línea
        ...
        function CargarDatos()
        {
            ...
            $this->CabeceraTabla = array('Id TipoBien','Descripcion');
            $RC = new Reporte_Catalogos();
            $this->DatosCatalogo = $RC->ObtenerArregloCatalogoTipoBien();
        }
        ...
        function GenerarReporte()
        {
            ...
            $this->Output('reporte_catalogo_tipobien.pdf', 'I');
        }
    }
