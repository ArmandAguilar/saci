<?php
    ...
    class PDF extends FPDF
    {
        ...
        {
            $this->AnchoColumnas = array(30,25,25,25,25,50,40,55);
            $this->CabeceraTabla = array('Registro','Pedido','Documento','Total','Cantidad','Descripcion Articulo','Tipo Movimiento', 'Proveedor');
        ...
        {	
            ...
            $this->Output('reporte_entradas_pdf.pdf', 'I');
        }
    }
