<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'de Parametro',0,0,'C');
            // Salto de línea
        ...
        {
            $this->AnchoColumnas = array(30,130,115);
            $this->CabeceraTabla = array('Id Parametro','Descripcion','Valor');
            $RC = new Reporte_Catalogos();
            $this->DatosCatalogo = $RC->ObtenerArregloCatalogoParametro();
        }
        ...
        function GenerarReporte()
        {
            ...
            $this->Output('reporte_catalogo_parametro.pdf', 'I');
        }
    }
