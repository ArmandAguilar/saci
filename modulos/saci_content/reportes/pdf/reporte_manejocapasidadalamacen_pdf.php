...
class PDF extends FPDF
{
	...
	// Cargar los datos
	function CargarDatos($F1,$F2)
	{
		$this->AnchoColumnas = array(30,30,30,30,25,25,80,40,20,20);
		$this->CabeceraTabla = array('P.Presupuestal','Cve.Cabms','Exist. Inicial','Mov.Entrada Inicial','Mov.Entrada Salida','Saldo','U.Administrativa','Saldo U.Medida','Max','Min');
		$RC = new DA1();
		$info->FechaIncial =$F1;
		$info->FechaFinal = $F2;
	...
	function GenerarReporte($FechaInicial,$FechaFinal)
	{
		...
		// Datos
		$this->CargarDatos($FechaCorrectainicial,$FechaCorrectaFinal);
