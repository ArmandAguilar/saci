<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'de Factor Pronostico',0,0,'C');
            // Salto de línea
        ...
        {
            $this->AnchoColumnas = array(30,30,40,80);
            $this->CabeceraTabla = array('Id','Año','Mes','Factor');
            $RC = new Reporte_Catalogos();
            $this->DatosCatalogo = $RC->ObtenerArregloCatalogoFactorPronostico();
        }
        ...
        function GenerarReporte()
        {
            ...
            $this->Output('reporte_catalogo_factorpronostico.pdf', 'I');
        }
    }
