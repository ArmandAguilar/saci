<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'Entradas y Salidas',0,0,'C');
            // Salto de línea
        ...
        // Cargar los datos
        function CargarDatos($FechaInicial,$FechaFinal,$Cbo)
        {
            $this->AnchoColumnas = array(30,40,110,20,60,20);
        ...
        function GenerarReporte($FechaInicial,$FechaFinal,$Cbo)
        {	
            // Datos
        	
            $this->CargarDatos($FechaInicial,$FechaFinal,$Cbo);
            $this->AddPage();
            ...
            $this->Output('reporte_emtradaysalidas_pdf.pdf', 'I');
        }
    }
