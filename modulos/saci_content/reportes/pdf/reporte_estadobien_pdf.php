<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(5);        
            $this->Cell(0,5,'de Estado Bien',0,0,'C');
            // Salto de línea
        ...
        function CargarDatos()
        {
            ...
            $this->CabeceraTabla = array('Id EdoBien','Descripcion');
            $RC = new Reporte_Catalogos();
            $this->DatosCatalogo = $RC->ObtenerArregloCatalogoEdoBien();
        }
        ...
        function GenerarReporte()
        {
            ...
            $this->Output('reporte_catalogo_estadobien.pdf', 'I');
        }
    }
