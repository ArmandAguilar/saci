<?php    
    ...
    header("Content-Disposition: attachment; filename=reporte_resgurados_mueble.xls");
    ...
    ->setKeywords("")
    ->setCategory("");
    $PHPExcel->getActiveSheet()->setTitle('R. INFORMATICO');
    ...
    $PHPExcel->getActiveSheet()->mergeCells('A1:E1')->setCellValue('A1', 'REPORTE DE GENERACION DE RESGUARDO INFORMATICO')->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
