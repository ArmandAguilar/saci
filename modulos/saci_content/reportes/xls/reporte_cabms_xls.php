<?php
    ...
    header("Content-Disposition: attachment; filename=reporte_catalogo_cabms.xls");
    ...
    ->setKeywords("")
    ->setCategory("");
    $PHPExcel->getActiveSheet()->setTitle('CATALOGO DE CABMS');
    ...
    $PHPExcel->getActiveSheet()->mergeCells('A1:G1')->setCellValue('A1', 'REPORTE DE CATALOGO DE CABMS')->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    ->setCellValue("C7", "IDUMedida")
    ->setCellValue("D7", "Descripción")
    ->setCellValue("E7", "Tipo de Almacen")
    ->setCellValue("F7", "Consecutivo Inv.")
    ->setCellValue("G7", "Partida Presupuestal");
