<?php
    ...
    header("Content-Disposition: attachment; filename=reporte_catalogo_giros.xls");
    ...
    ->setKeywords("")
    ->setCategory("");
    $PHPExcel->getActiveSheet()->setTitle('CATALOGO DE GIROS');
    ...
    $PHPExcel->getActiveSheet()->mergeCells('A1:B1')->setCellValue('A1', 'REPORTE DE CATALOGO DE GIROS')->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
