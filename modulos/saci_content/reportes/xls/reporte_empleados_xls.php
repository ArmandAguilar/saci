<?php
    ...
    header("Content-Disposition: attachment; filename=reporte_catalogo_empleados.xls");
    ...
    ->setKeywords("")
    ->setCategory("");
    $PHPExcel->getActiveSheet()->setTitle('CAT. DE EMPLEADOS');
    ...
    $PHPExcel->getActiveSheet()->mergeCells('A1:G1')->setCellValue('A1', 'REPORTE DE CATALOGO DE EMPLEADOS')->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    ->setCellValue("A7", "No. Empleado")
    ->setCellValue("B7", "Nombre")
    ->setCellValue("C7", "RFC")
    ->setCellValue("D7", "Zona de Pago")
    ->setCellValue("E7", "Z. P. Ant.")
    ->setCellValue("F7", "Cargo")
