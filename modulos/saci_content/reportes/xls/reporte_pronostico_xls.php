<?php    
    ...
    header("Content-Disposition: attachment; filename=reporte_pronostico.xls");
    ...
    ->setKeywords("")
    ->setCategory("");
    $PHPExcel->getActiveSheet()->setTitle('Pronosticos');
    ...
    $PHPExcel->getActiveSheet()->mergeCells('A1:K1')->setCellValue('A1', 'REPORTE PRONOSTICO DE CONSUMO')->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    ->setCellValue("C7", "P. Consumo A.")
    ->setCellValue("D7", "P. Consumo B.")
    ->setCellValue("E7", "A. Base Ant.")
    ->setCellValue("F7", "A. Base")
    ->setCellValue("G7", "A. a Pronosticar")
    ->setCellValue("H7", "Mes a Pronosticar");
