<?php    
    ...
    header("Content-Disposition: attachment; filename=reporte_entrada.xls");
    ...
    ->setKeywords("")
    ->setCategory("");
    $PHPExcel->getActiveSheet()->setTitle('CONSUMIBLE ENTRADA');
    ...
    $PHPExcel->getActiveSheet()->mergeCells('A1:K1')->setCellValue('A1', 'REPORTE DE ENTRADA')->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    ->setCellValue("A7", "Cve.CABMS")
    ->setCellValue("B7", "Fecha")
    ->setCellValue("C7", "No. Pedido")
    ->setCellValue("D7", "Documento")
    ->setCellValue("E7", "Total")
    ->setCellValue("F7", "Cantidad")
    ->setCellValue("G7", "Cve.Cambs")
    ->setCellValue("H7", "Cve.CABMS")
    ->setCellValue("I7", "Tipo Mov.")
    ->setCellValue("J7", "Cve. Proveedor")
    ->setCellValue("K7", "Proveedor");
    
    
    $RC = new Reporte_Consumible_Entrada();
