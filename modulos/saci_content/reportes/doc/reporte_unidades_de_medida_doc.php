<?php
    ...
    header("Content-Disposition: inline; filename=reporte_catalogo_unidades_de_medida.doc");
    ...
    $table->addRow(100);
    $table->addCell(1600)->addText('IDUnidadMedida', $styleCell, array('align'=>'center'));
