...
--
-- Host: internal-db.s124453.gridserver.com
-- Generation Time: Jan 16, 2014 at 04:19 PM
...
CREATE TABLE IF NOT EXISTS `sa_acervo` (
  `Id_CABMS` text,
...
CREATE TABLE IF NOT EXISTS `sa_cabms` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14196 ;
...
CREATE TABLE IF NOT EXISTS `sa_cargainiarticulo` (
  ...
  `eNumFolioCarga` int(10) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`eNumFolioCarga`)
...
CREATE TABLE IF NOT EXISTS `sa_consumohistorico` (
  `Id_CABMS` text,
...
CREATE TABLE IF NOT EXISTS `sa_contrarecibo` (
...
CREATE TABLE IF NOT EXISTS `sa_detallepedido` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_empleado` (
  `Id_NumEmpleado` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_estadobien` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_existenciasconsumible` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_factorpronostico` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_fechaprogramadaentrega` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Id_Pedido` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sa_giro` (
  `Id_Giro` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_grid` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_grid_otroscargos` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Id_CABMS` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sa_informatico` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Id_CABMS` text,
  `vNumSerie` text,
  `Id_ConsecutivoInv` text,
  ...
  `vMouseMarca` text,
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10417 ;
...
CREATE TABLE IF NOT EXISTS `sa_inventario` (
  `Id_ConsecutivoInv` int(11) NOT NULL AUTO_INCREMENT,
  `Id_CABMS` text,
  `Id_TipoBien` text,
...
CREATE TABLE IF NOT EXISTS `sa_inventarioanterior` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
  `Id_InventarioAnterior` text,
  `dFechaFactura` date DEFAULT NULL,
  `eNoFactura` text,
...
CREATE TABLE IF NOT EXISTS `sa_inventariofisico` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
  `Id_Cabms` text,
  `Id_ConsecutivoInv` text,
  `Id_unidad` text,
...
CREATE TABLE IF NOT EXISTS `sa_localizacion` (
...
CREATE TABLE IF NOT EXISTS `sa_locarticulos` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Id_Localizacion` text,
  `Id_CABMS` text,
...
CREATE TABLE IF NOT EXISTS `sa_menu_catalogos` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_menu_procesos` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `IdUsuario` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sa_menu_reportes` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `IdUsuario` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sa_movconsumo` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
  `Id_CABMS` text,
  `Id_Unidad` text,
...
CREATE TABLE IF NOT EXISTS `sa_movdirecto` (
  `Id_Unidad` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sa_movinventario` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Id_CABMS` text,
  `Id_ConsecutivoInv` text,
  `Resguardante1` text,
...
CREATE TABLE IF NOT EXISTS `sa_mueble` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
  `Id_CABMS` text,
  `vCaracteristicas` text,
  `Id_ConsecutivoInv` text,
...
CREATE TABLE IF NOT EXISTS `sa_parametro` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
(59, '8', 'TITULO REPORTES 1', 'SECRETARIA DE EDUCACION'),
...
CREATE TABLE IF NOT EXISTS `sa_pedido` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_proveedor` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_tipobieninventariable` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_tipomovimiento` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `sa_umedida` (
  `Id_UMedida` int(10) NOT NULL AUTO_INCREMENT,
  `vDescripcion` varchar(60) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sa_unidadadmva` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
  `Id_Unidad` text,
...
(23, '0001', 'Oliver', 'Edgar Oliver R.', 'fcea920f7412b5da7be0cf42b8c93759', 'YES');
...
CREATE TABLE IF NOT EXISTS `sa_vehiculo` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Id_CABMS` text,
  `vMarca` text,
  `Id_ConsecutivoInv` text,
...
CREATE TABLE IF NOT EXISTS `sa_zona` (
  `Id_Zonas` int(10) DEFAULT NULL,
